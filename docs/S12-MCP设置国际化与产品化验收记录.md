...
- 产品化：中英文资源键对称；MCP、设置和首批 SQL 工具界面完成资源化；明暗 SVG 图标、Apache-2.0 LICENSE/NOTICE、隐私说明、第三方清单、发布升级/回滚说明已加入。
...
- 整体行覆盖率：13694/16305，83.98%；S12 产品化核心：1065/1204，88.46%；均高于 70%/85% 阻断线。
...
- ZIP：`07cd9abbfefc8cfcb52fcdb2908b173befb42e4711e0e9dfd81b1481bdec5635`；包内只有插件 JAR，JAR 含 LICENSE、NOTICE、明暗图标和中英文资源，不含独立第三方运行时 JAR。
...
- 其余历史数据库/生成/SQL 工具界面仍需继续迁移为中英文资源并补静态门禁；不得提前宣称国际化完成。
