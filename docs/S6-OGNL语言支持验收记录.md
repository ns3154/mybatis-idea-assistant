...
- 当前 checkout 的 S4～S6 分组测试 326/326 通过，覆盖 OGNL lexer/parser/AST、语义类型、引用、补全、Kotlin 语义和 XML 注入；全量 Gradle 门 760/760、84.40% 行覆盖率通过。
- 真实 IntelliJ 沙箱生命周期 1/1、100/100 与可选依赖隔离 5/5 已通过；生产代码仍不执行 OGNL。
- 副屏高亮、补全、导航、Find Usages、Rename preview/Undo 和最终 SHA 的 GitHub 远端门仍待外部环境。
