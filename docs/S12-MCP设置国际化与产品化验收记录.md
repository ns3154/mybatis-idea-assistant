...
- 产品化：中英文资源键对称；设置、MCP、数据库、生成和 SQL 工具直接界面完成资源化，并由 `verifyLocalizedUserInterface` 阻止新增硬编码中文字符串；明暗 SVG 图标、Apache-2.0 LICENSE/NOTICE、隐私说明、第三方清单、发布升级/回滚说明已加入。
...
- 整体行覆盖率：13701/16395，83.57%；S12 产品化核心：1065/1204，88.46%；均高于 70%/85% 阻断线。
...
- ZIP：`6ecd1ff759e0c77b8c285bb8533fdad523d588f5ac66817e04c6f244dc5489d4`；包内只有插件 JAR，JAR 含 LICENSE、NOTICE、明暗图标和中英文资源，不含独立第三方运行时 JAR。
...
- 核心语义、转换器和解析器的历史诊断文案仍有固定中文，虽然不属于直接界面控件，但会在错误路径透传到界面；仍需形成类型化诊断资源目录，不得提前宣称全产品英文错误文案完成。
