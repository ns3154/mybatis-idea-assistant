...
public final class MyBatisConfigurationIndex extends FileBasedIndexExtension<String, Void> {
    public static final ID<String, Void> NAME = ID.create("mybatis.idea.assistant.configuration");
    ...
    public @NotNull DataIndexer<String, Void, FileContent> getIndexer() {
        return inputData -> {
            ...
            for (MyBatisConfigurationEntry entry
                    : MyBatisConfigurationScanner.scan(inputData.getContentAsText())) {
                ProgressManager.checkCanceled();
                keys.put(entry.indexKey(), null);
                keys.put(MyBatisConfigurationKey.all(entry.kind()), null);
            }
            return keys;
        };
    }
