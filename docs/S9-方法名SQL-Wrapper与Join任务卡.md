...
- 原 S9 快照已有独立自动门；set-based 批量增量已随 2026-08-19 当前工作区通过禁用构建缓存的独占本地统一门（744/744，15389/18234，84.40%，最低 `IU-252.28539.54` Verifier `Compatible`），本地加固生命周期 1/1 与可选依赖隔离 5/5 也已通过；新 HEAD 远端门、同一 SHA 生命周期 100/100 和副屏 Database Tools 三个动作的实机复核仍待；
